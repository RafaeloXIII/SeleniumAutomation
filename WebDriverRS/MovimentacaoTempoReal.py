...
#Total de pacotes sem movimentacao
totalMov_element = navegador.find_element(By.CSS_SELECTOR, '#pane-first > div > div.el-table.el-table--fit.el-table--striped.el-table--border.el-table--scrollable-x.el-table--enable-row-transition.el-table--small > div.el-table__body-wrapper.is-scrolling-left > table > tbody > tr > td.el-table_1_column_31.is-center > div > span > button')
totalMov_element.click()
