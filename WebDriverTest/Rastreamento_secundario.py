...
#Gestão de viagens de linha secundária 
gestao_element = navegador.find_element(By.CSS_SELECTOR, '#gateway > div.home > div.homeLeft.el-scrollbar > div.el-scrollbar__wrap > div > div.sidebar > div.sidebar-body > ul.el-menu-vertical-right.el-menu > li:nth-child(1)') 
gestao_element.click()                                     
time.sleep(5)

#Consulta viagens
input_regional = navegador.find_element(By.CSS_SELECTOR, '#gateway > div.home > div.homeLeft.el-scrollbar > div.el-scrollbar__wrap > div > div.sidebar > div.sidebar-body > ul.el-menu-vertical-right.el-menu > li.el-submenu.is-opened > ul > li:nth-child(2)') 
...
#baixar excel
baixar_excel = navegador.find_element(By.CSS_SELECTOR, '#__qiankun_microapp_wrapper_for_transport_platform_index__ > div > div > div.download-list2.download-center2 > div > div > div.el-dialog__body > div > div.el-table.el-table--fit.el-table--striped.el-table--border.el-table--enable-row-transition.el-table--small > div.el-table__fixed-right > div.el-table__fixed-body-wrapper > table > tbody > tr:nth-child(1) > td.el-table_2_column_51 > div > button')
baixar_excel.click()
time.sleep(20)
navegador.quit()
