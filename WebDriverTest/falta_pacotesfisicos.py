...
time.sleep(5)
 ...
 #ITEM 1
code1 = "Encomenda.expedido.mas.não.chegou.有发未到件"
lista_nivel2.send_keys(code1)
lista_nivel2.send_keys(Keys.ENTER)
time.sleep(5)

# code = "Encomenda.expedido.mas.não.chegou.有发未到件"
# lista_nivel2.send_keys(Keys.CONTROL, 'f')

# lista_nivel2.send_keys(code)
# time.sleep(3)

# item_selecionar = navegador.find_element(By.CSS_SELECTOR, '/html/body/div[6]/div[1]/div[1]/ul/li[140]/span')
# item_selecionar.click()
# time.sleep(3)
