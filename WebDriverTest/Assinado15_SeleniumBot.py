...
# clicar em por hora de inicio
por_data_downloads_element = navegador.find_element(By.CSS_SELECTOR,'#jmsSearch > form > div:nth-child(4) > div > div > div > input')
...
# Calcula a data atual menos 30 minutos
data_atual_menos_30 = datetime.now() - timedelta(minutes=30)
data_formatada_menos_30 = data_atual_menos_30.strftime("%Y-%m-%d %H:%M:%S")
time.sleep(5)

# Escrever a data atual menos 30 minutos no campo selecionado
por_data_downloads_element.send_keys(data_formatada_menos_30)
time.sleep(3)
