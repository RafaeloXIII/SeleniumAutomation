...
# PACOTES BARRADOS
pacotes_barrados = navegador.find_element(By.CSS_SELECTOR, '#gateway > div.home > div.homeLeft.el-scrollbar.mini > div.el-scrollbar__wrap > div > div.sidebar.siderbar-mini > div.sidebar-body > ul.el-menu-vertical-left.el-menu > li:nth-child(3)')
pacotes_barrados.click()
time.sleep(5)

# GESTÃO DE PACOTES DEVOLVIDOS
pacotes_devolvidos = navegador.find_element(By.CSS_SELECTOR, '#gateway > div.home > div.homeLeft.el-scrollbar > div.el-scrollbar__wrap > div > div.sidebar > div.sidebar-body > ul.el-menu-vertical-right.el-menu > li:nth-child(2)')
pacotes_devolvidos.click()
time.sleep(5)
   
# ABA "APROVADOS"
lista_element = navegador.find_elements(By.CSS_SELECTOR, '#tab-2')
lista_element[1].click()
time.sleep(5)
...
try:
  ...
  print("\033[31mNADA PARA EXPORTAR\033[0m")
  navegador.quit()
  exit()
...
#baixar excel
baixar_excel = navegador.find_element(By.CSS_SELECTOR, '#pane-1 > div > div.download-list > div > div > div.el-dialog__body > div > div.el-table.el-table--fit.el-table--striped.el-table--border.el-table--scrollable-x.el-table--enable-row-transition.el-table--small > div.el-table__fixed-right > div.el-table__fixed-body-wrapper > table > tbody > tr:nth-child(1) > td.el-table_2_column_24 > div > button:nth-child(1)')
baixar_excel.click()
time.sleep(10)
