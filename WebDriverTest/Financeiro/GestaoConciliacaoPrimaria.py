...
#Gestão de faturamento de transferência primária
gestao_faturamento = navegador.find_element(By.CSS_SELECTOR, '#gateway > div.home > div.homeLeft.el-scrollbar > div.el-scrollbar__wrap > div > div.sidebar > div.sidebar-body > ul.el-menu-vertical-right.el-menu > li:nth-child(1)')
gestao_faturamento.click()
time.sleep(15)

# Resumo Diario
resumo_diario = navegador.find_element(By.CSS_SELECTOR,'#tab-second')
resumo_diario.click()
time.sleep(5)

# Gestão de conciliação de contas a receber
gestao_conciliacao = navegador.find_elements(By.CSS_SELECTOR,'#pane-second > div > div.zd-tab-submenu > div > div > label.el-radio-button.el-radio-button--small')
gestao_conciliacao[1].click()
time.sleep(15)
...
# enviar
enviar_element = navegador.find_element(By.CSS_SELECTOR, 'body > div:nth-child(27) > div > div.el-dialog__footer > span > button.el-button.el-button--primary.el-button--small')
