...
#Relatorio
faturamento_element = navegador.find_element(By.CSS_SELECTOR, '#gateway > div.home > div.homeLeft.el-scrollbar.mini > div.el-scrollbar__wrap > div > div.sidebar.siderbar-mini > div.sidebar-body > ul.el-menu-vertical-left.el-menu > li:nth-child(4)')
faturamento_element.click()
time.sleep(15)

#Relatório de Premiações/Penalizações
...
#Data
data_element = navegador.find_element(By.CSS_SELECTOR,'#jmsSearch > form > div:nth-child(9) > div > div:nth-child(2) > div:nth-child(1) > input')
data_element.click()
time.sleep(5)

data_element.send_keys(Keys.ARROW_LEFT)
time.sleep(0.3)
...
# clicar em exportar
exportar_element = navegador.find_elements(By.CSS_SELECTOR, '#jmsTopMenu > div.avue-crud__left > button:nth-child(4)')
...
downloads_element = navegador.find_elements(By.CSS_SELECTOR, '#jmsTopMenu > div.avue-crud__left > button:nth-child(5)')
