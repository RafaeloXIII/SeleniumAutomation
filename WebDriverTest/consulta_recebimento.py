...
num_down_arrows_recebimento = 5 
for _ in range(num_down_arrows_recebimento):
  lista_tipobipagem.send_keys(Keys.ARROW_DOWN)
  time.sleep(0.5)
lista_tipobipagem.send_keys(Keys.ENTER)
time.sleep(5) 
# code = "bipe de expedição"
# lista_tipobipagem.send_keys(Keys.CONTROL, 'f')

# lista_tipobipagem.send_keys(code)
# time.sleep(3)

# bipe_expedicao = navegador.find_element(By.CSS_SELECTOR, '/html/body/div[4]/div[1]/div[1]/ul/li[4]/span')
# bipe_expedicao.click()
# time.sleep(2)
