...
from edge_manager.edge_manager import WebDriverManager
import json
...
taxa_element = navegador.find_element(By.CSS_SELECTOR, '#gateway > div.home > div.homeLeft.el-scrollbar > div.el-scrollbar__wrap > div > div.sidebar > div.sidebar-body > ul.el-menu-vertical-right.el-menu > li:nth-child(12) > div > div')
taxa_element.click()
time.sleep(10)
...
# # por data de envio
# por_data_element = navegador.find_elements(By.CSS_SELECTOR, '#jmsSearch > form > div:nth-child(1) > div > div:nth-child(1) > div > div > label:nth-child(1) > span.el-radio__input > span')
# por_data_element[1].click()                                    
# time.sleep(5)
...
remetente_element.send_keys('SC')
time.sleep(3)
