...
# try:
#   code = "Assinatura de encomenda"
#   lista_tipobipagem.send_keys(Keys.CONTROL, 'f')

#   lista_tipobipagem.send_keys(code)
#   time.sleep(3)

#   assinatura_element = navegador.find_element(By.CSS_SELECTOR, 'body > div:nth-child(33) > div.el-scrollbar > div.el-select-dropdown__wrap.el-scrollbar__wrap > ul > li.el-select-dropdown__item.selected > span')
#   assinatura_element.click()
#   time.sleep(20)

# except NoSuchElementException:
#   pyautogui.click(559, 251, interval=5)
#   pyautogui.hotkey('ctrl', 'f')
#   pyautogui.write('assinatura de encomenda')
#   pyautogui.sleep(2)
#   pyautogui.click(569, 356,interval=3)
# consultar
